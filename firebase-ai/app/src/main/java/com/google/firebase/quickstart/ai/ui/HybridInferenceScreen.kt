...
@Composable
fun HybridInferenceScreen(viewModel: HybridInferenceViewModel = viewModel()) {
  ...
  val cameraLauncher =
    rememberLauncherForActivityResult(
      ...
      onResult = { bitmap -> bitmap?.let { viewModel.scanReceipt(it) } },
    )
    ...
    Row(
      ...
      Column {
        ...
        if (inferenceMode.isNotEmpty()) {
          Text(inferenceMode, style = MaterialTheme.typography.labelSmall, color = Color.Gray)
        }
      }
      Text(
