...
class MainActivity : AppCompatActivity(), View.OnClickListener {
  ...
  private fun addNumbers(a: Int, b: Int): Task<Int> {
    ...
    val data = hashMapOf("firstNumber" to a, "secondNumber" to b)

    // Call the function and extract the operation from the result
    return functions.getHttpsCallable("addNumbers").call(data).continueWith { task ->
  ...
  private fun addMessage(text: String): Task<String> {
    ...
    return functions.getHttpsCallable("addMessage").call(data).continueWith { task ->
      // This continuation runs on either success or failure, but if the task
  ...
  private fun onCalculateClicked() {
    ...
    addNumbers(firstNumber, secondNumber).addOnCompleteListener { task ->
