  ...
  override fun getChoices(): List<Choice> {
    return listOf(
      Choice(
        ...
        Intent(this, com.google.samples.quickstart.config.java.MainActivity::class.java),
      ),
      Choice(
        "Kotlin",
        "Run the Firebase Remote Config quickstart written in Kotlin.",
        Intent(this, com.google.samples.quickstart.config.kotlin.MainActivity::class.java),
      ),
    )
  }
}
