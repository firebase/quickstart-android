 ...
 *
 * See [MyUploadService] for upload example. See [MyDownloadService] for download example.
 */
class MainActivity : AppCompatActivity(), View.OnClickListener {
      ...
      object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
          ...
          when (intent.action) {
            ...
            MyUploadService.UPLOAD_ERROR -> onUploadResultIntent(intent)
          }
        }
      }
  ...
  private fun beginDownload() {
    fileUri?.let {
      ...
      val intent =
        Intent(this, MyDownloadService::class.java)
  ...
  private fun showMessageDialog(title: String, message: String) {
    val ad = AlertDialog.Builder(this).setTitle(title).setMessage(message).create()
    ad.show()
  }
