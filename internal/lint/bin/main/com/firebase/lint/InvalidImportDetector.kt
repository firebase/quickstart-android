...
val ISSUE_INVALID_IMPORT =
  Issue.create(
    ...
    9,
    Severity.ERROR,
    Implementation(InvalidImportDetector::class.java, Scope.JAVA_FILE_SCOPE),
  )
...
class InvalidImportDetector : Detector(), Detector.UastScanner {
  ...
  class InvalidImportHandler(private val context: JavaContext) : UElementHandler() {
    ...
    override fun visitImportStatement(node: UImportStatement) {
      ...
      node.importReference?.let { importedPackageName = it.asSourceString() }
