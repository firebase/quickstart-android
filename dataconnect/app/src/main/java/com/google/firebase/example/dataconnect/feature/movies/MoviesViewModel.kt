...
class MoviesViewModel(private val moviesConnector: MoviesConnector = MoviesConnector.instance) :
  ViewModel() {
  ...
  init {
    viewModelScope.launch {
      try {
        ...
        val latestMovies =
          moviesConnector.listMovies
            .execute { orderByReleaseYear = OrderDirection.DESC }
            .data
            .movies
