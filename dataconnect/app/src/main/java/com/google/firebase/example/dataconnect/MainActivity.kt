        ...
        Scaffold(
            ...
            NavigationBar {
              ...
              TOP_LEVEL_ROUTES.forEach { topLevelRoute ->
                ...
                NavigationBarItem(
                  ...
                  onClick = {
                    navController.navigate(topLevelRoute.route, { launchSingleTop = true })
                  },
                )
              }
            }
          ...
          NavHost(
            ...
            composable<MovieDetailRoute> {
              MovieDetailScreen(
                onActorClicked = { actorId ->
                  navController.navigate(ActorDetailRoute(actorId), { launchSingleTop = true })
                }
              )
            }
            composable<ActorDetailRoute>() {
              ActorDetailScreen(
                onMovieClicked = { movieId ->
                  navController.navigate(MovieDetailRoute(movieId), { launchSingleTop = true })
                }
              )
            }
            searchScreen()
