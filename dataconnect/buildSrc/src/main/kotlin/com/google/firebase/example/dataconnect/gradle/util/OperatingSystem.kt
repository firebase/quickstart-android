 ...
 */
public fun OperatingSystem.Type.Companion.forName(osName: String): OperatingSystem.Type? =
    forLowerCaseName(
        osName.lowercase()
    )
 ...
 * Returns the [OperatingSystem.Type] for the given operating system name.
 *
 * @param osArch the name of the operating system whose value to return; this value should be one
 * that was returned from [System.getProperty] called with `"os.name"`.
 */
public fun OperatingSystem.Architecture.Companion.forName(osArch: String): OperatingSystem.Architecture? =
