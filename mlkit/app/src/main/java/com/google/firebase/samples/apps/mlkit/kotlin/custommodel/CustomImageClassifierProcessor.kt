...
import com.google.firebase.samples.apps.mlkit.kotlin.VisionImageProcessor
...
constructor(private val activity: Activity): VisionImageProcessor {
    ...
    init{
        classifier =
                com.google.firebase.samples.apps.mlkit.kotlin.custommodel.CustomImageClassifier(activity)
    }
