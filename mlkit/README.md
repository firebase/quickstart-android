...
**NOTE:** An sample application using the same library, but with a more
...
can be found at <https://github.com/firebase/mlkit-material-android>. This may
be helpful when integrating ML Kit into a real-world applications.
