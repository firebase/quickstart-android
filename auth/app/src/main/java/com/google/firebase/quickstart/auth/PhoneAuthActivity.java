...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    private int mUiState = STATE_INITIALIZED;
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    // The sms quote for the project has been exceeded
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(KEY_UI_STATE, mUiState);
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mUiState = savedInstanceState.getInt(KEY_UI_STATE, STATE_INITIALIZED);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.button_verify_phone:
                verifyPhoneNumberWithCode(mVerificationId,
                        mVerificationField.getText().toString());
                break;
