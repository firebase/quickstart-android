...
class AnonymousAuthFragment : BaseFragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    // Click listeners
    binding.buttonAnonymousSignIn.setOnClickListener { signInAnonymously() }
    binding.buttonAnonymousSignOut.setOnClickListener { signOut() }
    binding.buttonLinkAccount.setOnClickListener { linkAccount() }
  }
