 ...
 * email address.
 */
public class PasswordlessFragment extends BaseFragment {
    ...
    private FragmentPasswordlessBinding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = FragmentPasswordlessBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBinding.passwordlessSendEmailButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onSendLinkClicked();
            }
        });
        mBinding.passwordlessSignInButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onSignInClicked();
            }
     ...
     * was launched.
     */
    private void checkIntent(@Nullable Bundle arguments) {
        // TODO: Check the args
