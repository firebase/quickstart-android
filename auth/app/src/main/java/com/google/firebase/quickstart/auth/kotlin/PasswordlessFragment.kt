...
import com.google.firebase.quickstart.auth.databinding.FragmentPasswordlessBinding

/**
 * Demonstrate Firebase Authentication without a password, using a link sent to an
 * email address.
 */
class PasswordlessFragment : BaseFragment() {

    private var pendingEmail: String = ""
    private var emailLink: String = ""
    private lateinit var auth: FirebaseAuth
    private var _binding: FragmentPasswordlessBinding? = null
    private val binding: FragmentPasswordlessBinding
        get() = _binding!!

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentPasswordlessBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.passwordlessSendEmailButton.setOnClickListener { onSendLinkClicked() }
        binding.passwordlessSignInButton.setOnClickListener { onSignInClicked() }
        binding.signOutButton.setOnClickListener { onSignOutClicked() }
     ...
     * was launched.
     */
    private fun checkIntent(arguments: Bundle) {
        // TODO: Update this
